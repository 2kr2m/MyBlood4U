...
//in this class an adpter to the notification class had been created
public class NotificationAdapter  extends RecyclerView.Adapter<NotificationAdapter.viewHolder>{
    ...
    public class viewHolder extends RecyclerView.ViewHolder{
        CircleImageView notification_profile_image;
        TextView notification_name,notification_text,notification_date;
